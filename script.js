...
class Factory {
  ...
  customerBuild(color,options){
    console.log("Building one" + color+" "+options.trim+" "+options.model+" "+options.options)
  }
}
...
class Sport extends Car {
  constructor (properties){
    ...
    this.trim = properties.trim
    this.transmission = properties.transmission
    this.top = properties.top
    this.color = properties.color
    this.seatstrim = properties.seatstrim
    this.audio = properties.audio
    this.wheelstrim = properties.wheelstrim
    this.moonroof = false
...
class Truck extends Factory {
  constructor (specs){
    ...
    this.enginesize = specs.enginesize
    this.hitch = specs.hitch
    this.bed = specs.bed
    this.navigation = specs.navigation
    this.standard = { 
      backupcamera = true
      audio = basic
    }
